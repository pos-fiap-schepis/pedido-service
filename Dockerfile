...
COPY --from=builder /app/target/pedido-service-0.0.1-SNAPSHOT.jar /app/pedido-service-0.0.1-SNAPSHOT.jar

ENTRYPOINT ["java", "-jar", "pedido-service-0.0.1-SNAPSHOT.jar"]
